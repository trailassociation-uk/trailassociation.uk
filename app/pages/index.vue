...
<template>
  <main class="relative flex flex-1 flex-col items-center justify-center bg-cover bg-center bg-no-repeat px-4 pt-16"
    ...
    <div class="relative z-10 mx-auto max-w-3xl text-center text-background">
      <h1 class="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
        Riders unite, trails thrive!
      </h1>
      <p class="mt-6 text-lg sm:text-xl">
        Whether you're forming a new association or boosting your existing crew, we're your sidekick every step of the
        way.
      </p>
