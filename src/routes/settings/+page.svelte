<script lang="ts">
  ...
  <div class="rounded bg-green-50 dark:bg-gray-800 lg:w-1/2 lg:mx-auto my-6">
  <Section name="crudcreateform">
    <h2 class="mb-4 -mt-12 text-xl font-bold text-gray-900 dark:text-white">Settings</h2>
    ...
    <hr class="my-8" />
    <h2 class="mb-4 text-md font-bold text-gray-900 dark:text-white">Change password</h2>
    <form on:submit|preventDefault={handleSubmit}>
      <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
        <div class="col-span-2">
